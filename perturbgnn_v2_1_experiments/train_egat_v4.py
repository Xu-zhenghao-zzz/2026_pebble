...
from perturbgnn_v2_1.egat import EGATEncoderV4, assemble_node_features
...
def main():
    ...
    ap.add_argument("--out", default=str(OUT_PROCESSED / "egat_encoder_v4_l1wide.pt"))
    ...
    print(f"\n=== Training v4 {args.epochs} epochs (patience {args.patience}) ===", flush=True)
    ...
    with open(LOGS / "egat_train_history_v4.json", "w") as f:
